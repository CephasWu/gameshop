								...
								<div class="product-inner equal-element">
									...
									<div class="product-thumb">
										<div class="thumb-inner">
											<a href="#"> <img style="height: 235px;"
												src="${basePath}/resources/assets/games/PS4_Monster_Hunter_World.jpg"
												alt="img">
											</a>
									...
									<div class="product-info">
										<h5 class="product-name product_title">
											<a href="#">PS4_Monster_Hunter_World</a>
										</h5>
									...
									<div class="product-inner equal-element">
										<div class="product-top">
											<div class="flash">
												...
												<a href="${basePath}/productEdit/${product.product_Id}">${product.product_Id}</a></span>
												</span>
											</div>
										</div>
										<div class="product-thumb">
											<div class="thumb-inner">
												<a href="${basePath}/productEdit/${product.product_Id}">
												...
												<div class="thumb-group">
													<div class="yith-wcwl-add-to-wishlist">
														<div class="yith-wcwl-add-button">
															<a href="${basePath}/productEdit/${product.product_Id}">${product.product_Name}</a>
														</div>
													</div>
													<a href="#" class="button quick-wiew-button">Quick View</a>
													<div class="loop-form-add-to-cart">
										...
										<div class="product-info">
											...
											<div class="group-info">
												...
												<del>
													<a onclick="return confirm('確定要下架嗎?(商品ID=${product.product_Id})')"
														href="${basePath}/productDelete?product_Id=${product.product_Id}">
														<input type="submit" class="button-submit" value="下架">
													</a>
												</del>
											</div>
										</div>
