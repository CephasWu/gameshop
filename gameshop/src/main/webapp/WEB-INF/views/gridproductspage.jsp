		...
		<div class="container">
				...
				<div class="col-lg-12">
					<div class="breadcrumb-trail breadcrumbs">
						<ul class="trail-items breadcrumb">
							...
							<li class="trail-item trail-end active">電玩</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="row">
				<div
					...
					<div class="site-main">
						<h3 class="custom_blog_title">電玩</h3>
						<div class="shop-top-control">
							...
							<form class="filter-choice select-form">
								s <span class="title">Sort by</span> <select title="sort-by"
												...
												<div class="thumb-group">
													<div class="yith-wcwl-add-to-wishlist">
														<div class="yith-wcwl-add-button">
															<a
																href="${basePath}/productdetails/${product.product_Id}">${product.product_Name}</a>
														</div>
													</div>
							...
							<c:forEach var="pageNumber" begin="1" end="${page.totalPages}">
								<c:choose>
									<c:when test="${pageNumber-1 != page.number }">
										<a href="${basePath}/gridproducts2?p=${pageNumber}"
