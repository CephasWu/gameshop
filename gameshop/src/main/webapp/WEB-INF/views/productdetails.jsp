						...
						<div class="details-product">
							<div class="details-thumd">
								...
								<div class="product-preview image-small product_preview">
									<div id="thumbnails" class="thumbnails_carousel owl-carousel"
										...
										<a href="#"
											data-image="${basePath}/resources/assets/images/details-item-1.jpg"
											data-zoom-image="${basePath}/resources/assets/images/details-item-1.jpg"
											class="active"> <img
											src="${basePath}/resources/assets/images/details-item-1.jpg"
											data-large-image="${basePath}/resources/assets/images/details-item-1.jpg"
											alt="img">
										</a> <a href="#"
											data-image="${basePath}/resources/assets/images/details-item-2.jpg"
											data-zoom-image="${basePath}/resources/assets/images/details-item-2.jpg">
											<img
											src="${basePath}/resources/assets/images/details-item-2.jpg"
											data-large-image="${basePath}/resources/assets/images/details-item-2.jpg"
											alt="img">
										</a> <a href="#"
											data-image="${basePath}/resources/assets/images/details-item-3.jpg"
											data-zoom-image="${basePath}/resources/assets/images/details-item-3.jpg">
											<img
											src="${basePath}/resources/assets/images/details-item-3.jpg"
											data-large-image="${basePath}/resources/assets/images/details-item-3.jpg"
											alt="img">
										</a> <a href="#"
											data-image="${basePath}/resources/assets/images/details-item-4.jpg"
											data-zoom-image="${basePath}/resources/assets/images/details-item-4.jpg">
											<img
											src="${basePath}/resources/assets/images/details-item-4.jpg"
											data-large-image="${basePath}/resources/assets/images/details-item-4.jpg"
											alt="img">
										</a>
									</div>
								</div>
							...
							<div class="details-infor">
								...
								<div class="availability">
									availability: <a href="#">${product.product_Count}</a>
								</div>
								<div class="price">
									<span>價格:${product.product_Price}</span>
								</div>								
								<div class="variations">
									...
									<div class="attribute attribute_size">
										...
										<div class="list-size list-item">
											<a href="#" class="">xs</a> <a href="#" class="">s</a> <a
												href="#" class="active">m</a> <a href="#" class="">l</a> <a
												href="#" class="">xl</a> <a href="#" class="">xxl</a>
										</div>
									</div>
								</div>
								<div class="group-button">
									...
									<div class="size-chart-wrapp">
										<div class="btn-size-chart">
											<a id="size_chart"
												href="${basePath}/resources/assets/images/size-chart.jpg"
						...
						<div class="tab-details-product">
							...
							<div class="tab-container">
								<div id="product-descriptions" class="tab-panel active">
									<p>Quisque quis ipsum venenatis, fermentum ante volutpat,
										...
										Maecenas dolor elit, fringilla nec turpis ac, auctor vulputate
										nulla. Phasellus sed laoreet velit.</p>
									<p>Proin fringilla urna vel mattis euismod. Etiam sodales,
										massa non tincidunt iaculis, mauris libero scelerisque justo,
										ut rutrum lectus urna sit amet quam. Nulla maximus vestibulum
										mi vitae accumsan.</p>
								</div>
									...
									<div class="reviews-tab">
										<div class="comments">
											<h2 class="reviews-title">
												1 review for <span>${product.product_Name}</span>
											</h2>
											<ol class="commentlist">
												<li class="conment">
													<div class="conment-container">
														<a href="#" class="avatar"> <img
															src="${basePath}/resources/assets/images/avartar.jpeg"
															alt="img">
														</a>
														<div class="comment-text">
															...
															<p class="meta">
																<strong class="author">Cobus Bester</strong> <span>-</span>
